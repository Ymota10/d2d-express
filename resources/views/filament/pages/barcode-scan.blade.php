                    ...
                    <table class="min-w-full border border-gray-300 dark:border-gray-700 rounded-lg">
                        ...
                        <tbody>
                            ...
                            @foreach($orders as $order)
                                ...
                                <tr class="{{ in_array($order['waybill_number'], $duplicates) 
        ...
        <div class="fixed inset-0 bg-black/50 flex items-center justify-center z-50">
            ...
            <div class="bg-white dark:bg-gray-900 p-6 rounded-lg w-96">
                ...
                <select wire:model="newStatus" class="w-full border rounded p-2 mb-4">
                    ...
                    <option value="partial_return_2">
                        Partial Return
                    </option>

                    <option value="time_scheduled">
                        Time Scheduled
                    </option>
                    ...
                    <option value="returned_and_cost_paid">
                        Returned and cost paid
                    </option>

                    <option value="returned_to_warehouse">
                        Returned to Warehouse
                    </option>

                    <option value="returned_to_shipper">
                        Returned to Shipper
                    </option>
